...
var r2 = class {
  static getFullOptions(e2) {
    return i({ clientTools: {}, onConnect: () => {
    }, onDebug: () => {
    }, onDisconnect: () => {
    }, onError: () => {
    }, onMessage: () => {
...
var v = class _v extends c {
  ...
  static async create(e2) {
    ...
    try {
      var n, o2, s;
      const i3 = null != (n = e2.origin) ? n : "wss://api.elevenlabs.io";
      let a2;
      ...
      } else a2 = `${i3}/v1/convai/conversation?agent_id=${e2.agentId}&source=${c2}&version=${r3}`;
      const h3 = ["convai"];
...
function w(e2, t) {
  return async (n, o2) => {
    ...
    const i2 = new Blob([t], { type: "application/javascript" }), a2 = URL.createObjectURL(i2);
    try {
...
var S = class _S extends c {
  ...
  static async create(n) {
    ...
    if ("conversationToken" in n && n.conversationToken) o2 = n.conversationToken;
      ...
      try {
        var s, i2, a2;
        const e2 = (null == (s = n.overrides) || null == (s = s.client) ? void 0 : s.version) || u, t = (null == (i2 = n.overrides) || null == (i2 = i2.client) ? void 0 : i2.source) || "js_sdk", c3 = `${r3 = null != (a2 = n.origin) ? a2 : "https://api.elevenlabs.io", r3.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, l2 = await fetch(c3);
    ...
    const c2 = new Room();
    try {
      const e2 = `room_${Date.now()}`, s2 = l("pcm_48000"), i3 = l("pcm_48000"), a3 = new _S(c2, e2, s2, i3, n), r4 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d2;
  ...
  async setAudioInputDevice(e2) {
    ...
    try {
      ...
      const n = { deviceId: { exact: e2 }, echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } }, i2 = await createLocalAudioTrack(n);
      await this.room.localParticipant.publishTrack(i2, { name: "microphone", source: Track.Source.Microphone });
    } catch (e3) {
...
var C = class _C extends r2 {
  static async startSession(e2) {
    ...
    let n = null;
    try {
      return await k(t.connectionDelay), n = await y(e2), new _C(t, n);
    } catch (e3) {
      var o2;
...
var I = class _I {
  static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: s, libsampleratePath: a2, onError: r3 }) {
    let c2 = null, l2 = null;
    try {
      const u3 = i({ sampleRate: { ideal: e2 } }, R);
      if (E() && n) {
      ...
      await b(c2.audioWorklet, null == s ? void 0 : s.rawAudioProcessor);
      const p2 = i({ voiceIsolation: true }, u3);
  ...
  constructor(e2, t, n, o2, s, i2, a2 = console.error) {
    ...
    }, this.context = e2, this.analyser = t, this.worklet = n, this.inputStream = o2, this.mediaStreamSource = s, this.permissions = i2, this.onError = a2, this.permissions.addEventListener("change", this.handlePermissionsChange);
  }
  ...
  async setInputDevice(e2) {
    try {
      ...
      const n = i({ voiceIsolation: true }, t), o2 = await navigator.mediaDevices.getUserMedia({ audio: n });
...
var A = class _A {
  static async create({ sampleRate: e2, format: t, outputDeviceId: n, workletPaths: o2 }) {
    ...
    try {
      ...
      const a3 = s.createAnalyser(), r4 = s.createGain();
      i2 = new Audio(), i2.src = "", i2.load(), i2.autoplay = true, i2.style.display = "none", document.body.appendChild(i2);
      const c2 = s.createMediaStreamDestination();
      i2.srcObject = c2.stream, r4.connect(a3), a3.connect(c2), await M(s.audioWorklet, null == o2 ? void 0 : o2.audioConcatProcessor);
      const l2 = new AudioWorkletNode(s, "audioConcatProcessor");
      return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r4), await s.resume(), n && i2.setSinkId && await i2.setSinkId(n), new _A(s, a3, r4, l2, i2);
    } catch (e3) {
      var a2, r3;
      throw null != (a2 = i2) && a2.parentNode && i2.parentNode.removeChild(i2), null == (r3 = i2) || r3.pause(), s && "closed" !== s.state && await s.close(), e3;
    }
  }
  constructor(e2, t, n, o2, s) {
...
var D = class _D extends r2 {
  ...
  static async startSession(e2) {
    ...
    let o2 = null, s = null, a2 = null, c2 = null, l2 = null;
    (null == (t = e2.useWakeLock) || t) && (l2 = await _D.requestWakeLock());
    try {
      var u2;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await k(n.connectionDelay), s = await y(e2), [o2, a2] = await Promise.all([I.create(i({}, s.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices, inputDeviceId: e2.inputDeviceId, workletPaths: e2.workletPaths, libsampleratePath: e2.libsampleratePath })), A.create(i({}, s.outputFormat, { outputDeviceId: e2.outputDeviceId, workletPaths: e2.workletPaths }))]), null == (u2 = c2) || u2.getTracks().forEach((e3) => {
        e3.stop();
      }), c2 = null, new _D(n, s, o2, a2, l2);
    } catch (e3) {
      var d2, h3, p2, m2;
      n.onStatusChange && n.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e4) => {
        e4.stop();
      }), null == (h3 = s) || h3.close(), await (null == (p2 = o2) ? void 0 : p2.close()), await (null == (m2 = a2) ? void 0 : m2.close());
      try {
        var v2;
  ...
  constructor(e2, t, n, o2, s) {
    ...
    }, this.input = n, this.output = o2, this.wakeLock = s, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage, s && (this.visibilityChangeHandler = () => {
      var e3;
  ...
  handleAudio(e2) {
    var t, n;
    super.handleAudio(e2), e2.audio_event.alignment && this.options.onAudioAlignment && this.options.onAudioAlignment(e2.audio_event.alignment), this.lastInterruptTimestamp <= e2.audio_event.event_id && (e2.audio_event.audio_base_64 && (null == (t = (n = this.options).onAudio) || t.call(n, e2.audio_event.audio_base_64), this.connection instanceof S || this.addAudioBase64Chunk(e2.audio_event.audio_base_64)), this.currentEventId = e2.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e2) {
    this.connection instanceof S ? this.connection.setMicMuted(e2) : this.input.setMuted(e2);
  }
  getInputByteFrequencyData() {
  ...
  async changeInputDevice({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2 }) {
    try {
      ...
      this.connection instanceof S && await this.connection.setAudioInputDevice(o2 || ""), await this.input.close();
      const s = await I.create({ sampleRate: null != e2 ? e2 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath, onError: this.options.onError });
  ...
  async changeOutputDevice({ sampleRate: e2, format: t, outputDeviceId: n }) {
    try {
      ...
      this.connection instanceof S && await this.connection.setAudioOutputDevice(n || ""), await this.output.close();
...
function T(e2, t, n = "https://api.elevenlabs.io") {
  const o2 = {};
  return "boolean" == typeof t ? o2.feedback = t ? "like" : "dislike" : (o2.rating = t.rating, o2.comment = t.comment), fetch(`${n}/v1/convai/conversations/${e2}/feedback`, { method: "POST", body: JSON.stringify(o2), headers: { "Content-Type": "application/json" } });
}
var F = class {
  constructor() {
...
export {
  ...
  I as Input,
  A as Output,
  x as RealtimeConnection,
  P as RealtimeEvents,
  N as Scribe,
  m as SessionConnectionError,
  C as TextConversation,
  D as VoiceConversation,
  S as WebRTCConnection,
  v as WebSocketConnection,
